 ...
 */
public class MyRatioCollectionFragment extends Fragment {
    ...
    public static MyRatioCollectionFragment newInstance() {
        Bundle args = new Bundle();
        MyRatioCollectionFragment fragment = new MyRatioCollectionFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getString(R.string.my_ratio_collection));
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_my_ratio_collection, container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        bundle.putBoolean("isRatioCollection", true);
        bundle.putBoolean("isTopRated", false);
